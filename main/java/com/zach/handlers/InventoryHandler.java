...
public class InventoryHandler {
    ...
    public void createAuctionHouseChest() {
        ...
        for (int i = 0; i <= getCellChestsAmount(); i++) {
            ...
            if (i > AuctionHouse.getInstance().creationListener.savedChestLocations.size())
                break;
        }
    ...
    private void auctionHouseLocations(int i, List<Chest> AuctionHouseChest) {
        ...
        for (Map.Entry<Location, String> location : AuctionHouse.getInstance().creationListener.saveChestDirections.entrySet()) {
